...
class MvcController{
	...
	public function ingresoUsuarioController(){
		...
		if(isset($_POST["usuarioIngreso"])){
			...
			$respuesta = Maestros::ingresoMaestroModel($datosController);
	...
	public function actualizarAlumnoController(){
		...
		if(isset($_POST['nombre'])){
			...
			$datosController = array( "matricula"=>$_GET['id'], "nombre"=>strtoupper($_POST["nombre"]),"carrera"=>strtoupper($_POST["carrera"]),"tutor"=>strtoupper($_POST["tutor"]));
	...
	public function registroAlumnoController(){
		...
		if(isset($_POST["matricula"])){
			...
			$datosController = array( "matricula"=>$_POST["matricula"], "nombre"=>strtoupper($_POST["nombre"]), "carrera"=>strtoupper($_POST["carrera"]), "tutor"=>strtoupper($_POST["tutor"]));
	...
	public function actualizarMaestroController(){
		...
		if(isset($_POST['nombre'])){
			...
			//se guardan los valores de POST en un arreglo obtenidos del formulario
			$datosController = array( "id"=>$_GET['id'],"nombre"=>strtoupper($_POST["nombre"]), "carrera"=>strtoupper($_POST["carrera"]), "email"=>$_POST["email"],"password"=>$_POST["password"]);
	...
	public function registroMaestroController(){
		...
		if(isset($_POST["nombre"])){
			//Recibe a traves del método POST el name (html) de usuario, password y email, se almacenan los datos en una variable de tipo array con sus respectivas propiedades (usuario, password y email):
			$datosController = array( "nombre"=>strtoupper($_POST["nombre"]),"carrera"=>strtoupper($_POST["carrera"]), "email"=>$_POST["email"], "password"=>$_POST["password"]);
	...
	public function actualizarCarreraController(){
		...
		if(isset($_POST['nombre'])){
			...
			//se guardan los valores de POST en un arreglo obtenidos del formulario
			$datosController = array( "id"=>$_GET['id'],"nombre"=>strtoupper($_POST["nombre"]));
